...
class Proveedor extends Validator{
    ...
    {
        $sql = 'SELECT idproveedorproducto,nombrecompania,representante,nombreproducto, precioporunidad, existencias, cantidadporunidad, descripcionproducto,tipoproducto, estadoproducto, pais, codigoproducto
