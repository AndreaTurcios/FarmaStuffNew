...
const ENDPOINT_TIPO = '../../app/api/private/tipoEmpleado.php?action=readAll';
        ...
        content += `
            <tr>   
                ...
                <td>
                    ...
                    <a href="../../app/reports/private/empleado.php?id=${row.idempleado}" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte"><i class="material-icons">assignment</i></a>
                </td>
            </tr>
        `;
    });
